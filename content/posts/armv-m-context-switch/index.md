...
<!-- {{< figure src="cpacr-reg-layout.png" title="Coprocesser Access Control Register" >}} -->
...
<!-- {{< figure src="context-state-stacking-basic.png"  title="Context State Stacking Basic" >}} -->
...
<!-- {{< figure src="fpccr-reg.png" title="Floating Point Context Control Register" >}} -->
